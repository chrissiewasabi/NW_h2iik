...
import github.droidfu.http.ssl.EasySSLSocketFactory;
import github.droidfu.support.DiagnosticSupport;
...
public class AsyncHttpClient {
    ...
    public AsyncHttpClient() {
        ...
        HttpProtocolParams.setUserAgent(httpParams, String.format("Lipuka/Android/%s", VERSION));
    ...
    public HttpEntity paramsToEntity(RequestParams params) {
